...
<div id="layoutSidenav_content">
  <main>
    <div class="container-fluid">
      <h1 class="mt-4">Fiche de diagnostic</h1>
            ...
            <div class="card-header">
              <b>
                ...
                <ul class="nav nav-pills" style="float: right;">
                  <li class="nav-item">
                    <a class="nav-link active" href="<?= $diagnostique['option2_link'] ?>">
                        ...
                        <div class="card-body">
                          <fieldset>
                            <div class="table-responsive">
                              <form action="save_diagnostique.php" method="POST" enctype="multipart/form-data">
...
border-left-color: orange;">
                                ...
                                <div class="card mb-4">
                                  <div class="card-header">
                                    ...
                                    <b>Liste des maladies </b>
                                    <ul class="nav nav-pills" style="float: right;">
                                      <li class="nav-link active" data-toggle="modal" data-target="#ajouterMaladie" title="Modifier">
                                        <i class="fas fa-plus"></i> Ajouter maladie
                                  ...
                                  <table class="table table-border table-striped custom-table mb-0" id="TableIDExa">
                                    ...
                                    <tbody>
                                      <tr class="search-group" id="search-group-0">
                                        ...
                                        <td>
                                          <input type="search" id="searchBoxMaladie-0" class="form-control " placeholder="barre de recherche..." spellcheck="false">
                                          <select class="form-control " id="countriesMaladie-0"
                                            name="id_maladie[]">
                                            <?php

                                            $query = "SELECT * FROM maladie where open_close!=1 order by nom asc";
                                            $q = $db->query($query);
                                            while ($row = $q->fetch()) {
                                              $id_maladie = $row['id_maladie'];
                                              $nom = $row['nom'];

                                              echo '<option value ="' . $id_maladie . '">';
                                              echo $row['nom'];
                                              echo '</option>';
                                            }
                                ...
                                <div class="m-t-20 text-center">
                                  ...
                                  <a href="<?= $diagnostique['option2_link'] ?>" style=" width:150px;" class="btn btn-danger">
                                    <font>Annuler</font>
                                  </a>
...
<div class="modal fade" id="ajouterMaladie" role="dialog">
  <div class="modal-dialog">
    <!-- Modal content-->
    <div class="modal-content">
      <div class="modal-header" style="padding:20px 50px;">
        <h3 align="center"><i class="fas fa-clinic-medical"></i> <b> Ajouter Maladie</b></h3>
        <button type="button" class="close" data-dismiss="modal" title="Close">&times;</button>
      </div>
      <div class="modal-body" style="padding:40px 50px;">
        <form class="form-horizontal" action="save_maladie.php" name="form" method="post">
          <div class="form-group">
