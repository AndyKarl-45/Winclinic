...
?>
<?php
$ref_radiologie=$_REQUEST['ref_radiologie'];

$query  = "SELECT * from radiologie where ref_radiologie='".$ref_radiologie."'";
$q = $db->query($query);
while($row = $q->fetch())
{
    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid">
                <h1 class="mt-4">Détails  radiologie :  <?php echo $ref_radiologie?> </h1>
                            ...
                            <div class="card-header">
                                <b>
                                    <ul class="nav nav-pills" style="float: right;">
                                        <li class="nav-item">
                                            <a class="nav-link active" href="liste_radiologie.php">
                                                Retour
                                            </a>
                                        </li>
                                    </ul>
                                    ...
                                    <ul class="nav nav-pills">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" data-toggle="pill" href="#menu2">
                                                ...
                                                $query = "SELECT  count( DISTINCT id_type_radiologie) as total from radiologie_exa where   ref_radiologie_exa='$ref_radiologie'  ";
                                                $q = $db->query($query);
                                                while($row = $q->fetch())
                                                {

                                                    echo ' Type de radiologie['.$row['total'].']';
                                                }
                                                                    ...
                                                                    <table class="table  table-hover table-condensed" id="myTable">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                ...
                                                                                <div class="col">
                                                                                    <input type="date"
                                                                                           class="form-control" name="date_r_radiologie" value="<?=$date_radiologie?>" disabled>
                                                                                </div>
                                                                            </td>
                                                                        </tr>
                                        ...
                                        <div class="row">
                                            <div class="col-xl-12">
                                                <div class="card mb-4">
                                                    <div class="card-header">
                                                        <i class="fas fa-scroll"></i>
                                                        <b>L'ensemble des types de radiologie.</b>
                                                                        ...
                                                                        <form method="post" action="" >
                                                                            <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                                                                                ...
                                                                                <tr class="bg-primary">
                                                                                    ...
                                                                                    <th><p align="center" style="color: white">Types de radiologie</p></th>
                                                                                ...
                                                                                foreach($tables as $table)
                                                                                {
                                                                                    ...
                                                                                    $query = "SELECT * from type_radiologie where id_type_radiologie = '$id_type_radiologie'  ";
                                                                                    $q = $db->query($query);
                                                                                    while($row = $q->fetch())
                                                                                    {
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td align="center"><?=$date_radiologie?> </td>
                                                                                            <td align="center"><?php echo number_format($prix_t_radiologie) ?>  </td>
                                                                                           <td align="center">
                                                                                               <a class="btn btn-warning" data-toggle="modal" data-target="#modifierRadiologieExa<?=$id_type_radiologie?>"  title="Modifier"
                                                                                                  style="background-color: transparent">
                                                                                                   <i style="color: orange" class="fas fa-pen"></i>
                                                                                               </a>
                                                                                               <a class="btn btn-danger"  href="delete_exam_exa.php?ref_exa=<?php echo $ref_radiologie; ?>&id_type_exa=<?=$id_type_radiologie?>" title="view"
                                                                                                  style="background-color: transparent">
                                                                                                   <i  style="color: red" class="fas fa-trash"></i>
                                                                                               </a>
                                                                                            <div class="modal fade" id="modifierRadiologieExa<?=$id_type_radiologie?>" role="dialog">
                                                                                                    <div class="modal-dialog">
                                                                                                        <!-- Modal content-->
                                                                                                        <div class="modal-content">
                                                                                                            <div class="modal-header" style="padding:20px 50px;">
                                                                                                                <h3 align="center"><i class="fas fa-map"></i> <b>Type de radiologie</b></h3>
                                                                                                                <button type="button" class="close" data-dismiss="modal" title="Close">&times;</button>
                                                                                                            </div>
                                                                                                            <div class="modal-body" style="padding:40px 50px;">
                                                                                                                <form class="form-horizontal" action="update_radiologie_exa.php" name="form" method="post">

                                                                                                                    <div class="form-group">
                                                                                                                        <label>Type d'examen:</label>
                                                                                                                        <input  type="hidden" name="ref_radiologie" value="<?=$ref_radiologie?>" />
                                                                                                                        <input  type="hidden" name="id_radiologie" value="<?=$id_radiologie?>" />
                                                                                                                        <input  type="hidden" name="id_type_radiologie_last" value="<?=$id_type_radiologie?>" />
                                                                                                                        <div class="col-sm-12">
                                                                                                                            <select class="form-control"
                                                                                                                                    name="id_type_radiologie_new">
                                                                                                                                <option value="<?=$id_type_radiologie?>" selected=""><?=$nom?></option>
                                                                                                                                <?php

                                                                                                                                $iResult = $db->query("SELECT * FROM type_radiologie where open_close!=1 and id_type_radiologie!='$id_type_radiologie' ");
                                                                                                                    ...
                                                                                                                    <div class="form-group">
                                                                                                                        <label>Date de radiologie:</label>
                                                                                                                        <div class="col-sm-12">
                                                                                                                            <input class="form-control" type="date" name="date_radiologie" value="<?=$date_radiologie?>" />
                                                                                                                        </div>
                                                                                                                    </div>
                                                                                                                    <div class="form-group">
                                                                                                                        <div class="col-sm-12">
