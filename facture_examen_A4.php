...
$pdf->SetFont('Arial','',12);
$pdf->Text(85,40, 'INVOICE / RECEIPT');
$pdf->SetFont('Arial','',12);
$pdf->Text(10, 45, 'Date');
$pdf->Text(55, 45, $today);
$pdf->Text(10, 50, 'Sales point');
$pdf->Text(55, 50, 'CLINIQUE CATHOLIQUE SAINTE MARIE');
$pdf->Text(10, 55, 'Session');
$session = date("G");
...
$pdf->Text(55, 55, $session);
$pdf->SetFont('Arial','B',12);
$pdf->Text(10, 60, 'Facture No: ');
$pdf->Text(55,60, $ref_reg_exa);
$pdf->SetFont('Arial','',12);
$pdf->Text(10, 65, 'Cashier');
$pdf->Text(55,65, ucfirst(strtolower($nom_caissier)) );
$pdf->Text(10, 70, 'Client');
$pdf->Text(55,70, ucfirst(strtolower($nom_patiented)));
$pdf->Text(10, 75, 'Payment mode');
$pdf->Text(55,75, 'Cash');
$pdf->Text(10, 80, 'Nom Patient');
$pdf->Text(55,80, ucfirst(strtolower($nom_patiented)) );
$pdf->SetFont('Arial','B',12);
$pdf->SetXY(10, 85);
...
foreach ($id_medis as $id_med){
    ...
    $pdf->Text(12, 97+$i, strtoupper($type_exa[$id_med]));
    $pdf->Text(102, 97+$i, '1');
...
$pdf->Text(70,180, $somme);
$pdf->line(10,181,100,181);
$pdf->Text(10, 185, 'Amount paid');
$pdf->Text(70,185, $payer);
$pdf->line(10,186,100,186);
$pdf->Text(10, 190, 'Remise');
$pdf->Text(70,190, $remise);
$pdf->line(10,191,100,191);
$pdf->Text(10, 195, 'Difference');
$pdf->Text(70,195, $somme-($payer+$remise));
$pdf->line(10,196,100,196);
$pdf->SetFont('Arial','B',12);
$pdf->Cell(190 ,7,int2str($somme),0,1,'C');
$pdf->line(10,200,200,200);
$pdf->SetFont('Arial','',12);
$pdf->Cell(190 ,7,'We wish a speedy recovery',0, 1,'C');
$pdf->line(10,207,200,207);
$pdf->Cell(190 ,7,'Drugs sold can not be returned not exchanged',0, 1,'C');
$pdf->SetXY(10, 215);
