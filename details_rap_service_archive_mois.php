                ...
                <div class="row">
                    <div class="col-xl-12">
                        <b>
                            ...
                            <!--                                <li class="nav-item">-->
                            <!--                                    <a class="nav-link active" href="etat_print_rap_vente.php?id_caisse=--><?php //=$id_caisse?><!--" target="blank" style="margin-right: 20px" ><i class="fa fa-print"></i> Imprimer-->
                            <!--                                    </a>-->
                            <!--                                </li>-->
                            <!--                            </ul>-->
                    ...
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <table class="table table-border table-striped custom-table mb-0" id="dataTable">
                                ...
                                <tr>
                                    <!--                                    <th>Ref</th>-->
                                    <th>Mois(s)</th><th class="text-right"><i class="fas fa-bars"></i></th>
                                </tr>
                                </thead>
                                <tbody>
                                <?php
                                ...
                                $query = "SELECT month($date_service[$i]) as mois from $service where year($date_service[$i]) = $annee  group by month($date_service[$i])  order by $date_service[$i] asc";
                                ...
                                while ($row = $q->fetch()) {
                                    ...
                                    <tr>
                                        <td><a href="details_rap_rapport_archive.php?id=<?=$id_caisse?>&service=<?=$service?>&annee=<?=$annee?>&mois=<?=$mois?>"><img width="28" height="28" src="assetss/img/user.jpg"
                                                                                                                                         class="rounded-circle m-r-5"
                                                                                                                                         alt=""><?=$months[$mois]?></a></td>
