    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid">
                <h1 class="mt-4"> Ajouter Médicament à l'ordonnance</h1>
                                                        ...
                                                        <fieldset>
                                                            <div class="table-responsive">
                                                                <div class="col-lg-8 offset-lg-2">
                                                                    <form action="update_medi_ordo.php" method="POST" enctype="multipart/form-data">
                                                                        <div class="row">
                                                                            <div class="col-md-12">
                                                                                <hr/>
                                                                            </div>
                                                                                ...
                                                                                <div class="col">
                                                                                    <div class="form-group">
                                                                                        <?php if($lvl == 5){ ?>
                                                                                            ...
                                                                                            <label>Médecin<span
                                                                                                    class="text-danger">*</span></label>
                                                                                            <input type="hidden" class="form-control" name="id_medecin" value="<?=$id_medecin?>">
                                                                                        ...
                                                                                        <?php }elseif($lvl == 10){ ?>
                                                                                            ...
                                                                                            <label>Pharmacien<span
                                                                                                    class="text-danger">*</span></label>
                                                                                            <input type="hidden" class="form-control" name="id_pharmacien" value="<?=$id_pharmacien?>">
                                                                                            <select class="form-control" name="id_pharmacien">
                                                                                                <option value="<?=$id_pharmacien?>" selected><?=$nom_pharmacien?></option>
                                                                                            </select>
