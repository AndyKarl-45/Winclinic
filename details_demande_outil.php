                            ...
                            <div class="card-header">
                                <b>
                                    <ul class="nav nav-pills" style="float: right;">
                                        <li class="nav-item">
                                            <a class="nav-link active" href="liste_demande_outils.php">
                                                Retour
                                            </a>
                                        </li>
                                    </ul>
                                                                    ...
                                                                    <table class="table  table-hover table-condensed" id="myTable">
                                                                        ...
                                                                        <tr>
                                                                            <td style="width: 50%">
                                                                                ...
                                                                                <div class="col">
                                                                                    <input type="text" name="nom" value="<?=$nom?>" style="width:75%;border-top: 0; border-left: 0;
                                                                                border-right: 0;
                                                                        ...
                                                                        <form method="post" action="" >
                                                                            <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                                                                                ...
                                                                                <tr class="bg-primary">
                                                                                    ...
                                                                                    <th><p align="center" style="color: white">N° Lot</p></th>
