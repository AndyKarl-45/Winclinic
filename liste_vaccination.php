    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid">
                <h1 class="mt-4"><i class="fas fa-users" style="color: silver"></i> Liste des vaccinations</h1>
                    ...
                    <div class="col-xl-12">
                        ...
                        <b>
                            <ul class="nav nav-pills"   style="float: right; margin-right: 20px ;">
                                <li class="nav-item">
                                    <a class="nav-link" href="liste_vaccination_suite.php">

                                        <?php

                                        if($lvl == 3) {
                                            $query = "SELECT DISTINCT count(id_vac) as total from vaccination WHERE id_nurse = '$id_perso_session' and etat=0 ";
                                        }elseif($lvl == 5) {
                                            $query = "SELECT DISTINCT count(id_vac) as total from vaccination WHERE id_medecin = '$id_perso_session' and etat=0 ";
                                        }else{
                                            $query = "SELECT DISTINCT count(id_vac) as total from vaccination where  etat=0  ";
                                        }

                                        $q = $db->query($query);
                                        while($row = $q->fetch())
                                        {
                                            echo ' Vaccination en cours['.$row['total'].']';
                    ...
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <table class="table table-border table-striped custom-table mb-0" id="dataTable">
                                ...
                                <?php
                                if ($lvl == 3) {
                                    $query = "SELECT * from vaccination where id_nurse='$id_perso_session' and etat!=0 and open_close!=1 ";
                                }elseif ($lvl == 5) {
                                    $query = "SELECT * from vaccination where id_medecin='$id_perso_session' and etat!=0 and open_close!=1 ";
                                } else {

                                    $query = "SELECT * from vaccination where open_close!=1 and etat!=0";
                                }
