    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid">
                <h1 class="mt-4">Liste des Banques</h1>
...
<!--                                                Nouvelle Caisse-->
<!--                                            </a>-->
                                            <a class="btn btn-primary" href="nouvelle_add_banque.php">
                                                <i class="fas fa-cubes"></i>
                                                Nouvelle Banque
                                            </a>
                                        </li>
                                                ...
                                                <form method="post" action="">
                                                    <table class="table table-bordered table-hover" id="dataTable"
                                                        ...
                                                        <tr class="bg-primary">
                                                            ...
                                                            <th><p align="center" style="color: white">Banque</p></th>
                                                        ...
                                                        $query = "SELECT * from banque where open_close!='1'  order by date_banque asc";
                                                        $q = $db->query($query);
                                                        while ($row = $q->fetch()) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="center"><b><?=date("d-m-Y",strtotime($date_banque))?></b></td>
                                                                <td align="center" style="width:18%">
                                                                    <a class="btn btn-warning" href="modifier_add_banque.php?id=<?=$id_banque;?>" title="Modifier"
                                                                       style="background-color: transparent">
                                                                        <i style="color: orange" class="fas fa-pen"></i>
                                                                    </a>
                                                                    <a class="btn btn-danger"  href="delete_banque.php?id=<?=$id_banque;?>"   onclick="Supp(this.href); return(false);" style="background-color: transparent">
