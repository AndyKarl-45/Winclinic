...
$query  = "SELECT * from banque where id_banque='".$id."'";
$q = $db->query($query);
while($row = $q->fetch())
{
    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid">
                <h1 class="mt-4"> <i class="fas fa-building" style="color: silver"></i>Modifier banque: <?=$banque?> </h1>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-8 offset-lg-2">
                                            <form action="update_add_banque.php" method="POST">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" type="text" name="banque" value="<?=$banque?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            <label> Date</label>
                                                            <input class="form-control" type="date" name="date_banque" value="<?=$date_banque?>" >
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="m-t-20 text-center">
                                                    <button class="btn btn-primary submit-btn">Enregistrer</button>
                                                    <a href="liste_add_banque.php" style=" width:150px;" class="btn btn-danger"><font>Annuler</font></a>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
