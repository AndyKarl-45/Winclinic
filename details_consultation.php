    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid">
                <h1 class="mt-4">Détails de la fiche de Consultation: <?=$ref_con?></h1>
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-sm-6">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="form-group input-group">
                                                                                        <input type="number"
                                                                                               class="form-control"
                                                                                               required name="taille" value="<?=$taille?>" disabled/>
                                                                            ...
                                                                            <div class="col-sm-6">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="form-group input-group">
                                                                                        <input type="text"
                                                                                               class="form-control" name="sao" value="<?=$sao?>" 
                                                                                               value="0" disabled/>
                                                                                        <div class="input-group-prepend ">
                                                                            ...
                                                                            <div class="col-sm-6">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="form-group input-group">
                                                                                        <input type="text"
                                                                                               class="form-control" name="freq" value="<?=$freq?>" 
                                                                                               value="0" disabled/>
                                                                                        <div class="input-group-prepend ">
                                                                            ...
                                                                            <div class="col-sm-6">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="form-group input-group">
                                                                                        <input type="text"
                                                                                               class="form-control" name="poul" value="<?=$poul?>" 
                                                                                               value="0" disabled/>
                                                                                        <div class="input-group-prepend ">
                                                                    ...
                                                                    <form action="update_consultation.php" method="POST">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-sm-6">
                                                                                <div class="form-group">
                                                                                    <label>Médecin<span
                                                                                            class="text-danger">*</span></label>
                                                                                    <select class="form-control" name="id_medecin" disabled>
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <textarea class="form-control" rows="20" name="obs_medecin"
                                                                                      cols="70" disabled><?=$obs_medecin?></textarea>
                                                                        </div>
