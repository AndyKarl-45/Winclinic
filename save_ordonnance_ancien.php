...
$execute=0;
for($i = 0; $i <$id; $i++){
    echo '<br>id:'.$i.'-'.$id_num_lot[$i].'-'.$quantite[$i];
}
...
//                }
            ...
            if($k==0 and $tom==0){
                ...
                if($execute==0){
                    ...
                    $query = " INSERT INTO ordonnance (id_patient,id_medecin,id_depart,date_ordo,id_pharmacien,id_nurse) 
                                 VALUES (:id_patient,:id_medecin,:id_depart,:date_ordo,:id_pharmacien,:id_nurse)";
                ...
                $query = " INSERT INTO medicament_ordo (ref_medi_ordo,id_medi,id_num_lot,id_patient,id_medecin,id_depart,quantite_medi_ordo,date_medi_os_ordo,id_ordo,id_pharmacien,id_nurse,posologie,traitement) 
                     VALUES (:ref_medi,:id_medi,:id_num_lot,:id_patient,:id_medecin,:id_depart,:quantite_medi_ordo,:date_medi_os,:id_ordo,:id_pharmacien,:id_nurse,:posologie,:traitement)";
