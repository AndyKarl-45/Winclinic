...
$id_num_lot=$_REQUEST['id_num_lot'];
//$quantite=$_REQUEST['qt'];
//$id_ask_mat=$_REQUEST['id_ask_mat'];
$iResult = $db->query("SELECT * FROM magasin where id_medi='$id_medi' and id_num_lot='$id_num_lot'");
                                                ...
                                                <div class="card-body">
                                                    <fieldset>
                                                        <div class="table-responsive">
                                                            ...
                                                            <button class="accord">Numéro de lot: <b><?=$id_num_lot?></b></button>
                                                            <div class="panelle">
                                                                    ...
                                                                    <table  border="0" class="table  table-hover table-condensed" width="100%" cellspacing="0" >
                                                                        ...
                                                                        <tr>
                                                                            <td style="width: 45%">
                                                                                ...
                                                                                <div class="col">
                                                                                    <input type="hidden" name="id_num_lot"  value="<?=$id_num_lot?>">
