                        ...
                        <div class="table-responsive">
                            <table class="table table-border table-striped custom-table mb-0" id="dataTable">
                                ...
                                <?php
                                    ...
                                    $query = "SELECT * from medecin where open_close!=1  order by nom_m,prenom_m asc";
                                ...
                                while ($row = $q->fetch()) {
                                    ...
                                    // $profession = $row['profession'];
                                     ...
                                     if($id_medecin == $id_perso_session){
                                           $cnt++;
                                      }
                                        ...
                                        <td class="text-right">
                                            ...
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <a class="dropdown-item" href="details_medecin.php?id=<?= $id_medecin ?>"><i
