                    ...
                    <div class="col-xl-12">
                        <b>
                            ...
                            <ul class="nav nav-pills" style="float: right;">
                                <li class="nav-item">
                                    <a class="nav-link active" href="etat_print_rap_rapport_archive.php?id_caisse=<?= $id_caisse ?>&services=<?= $service ?>&id_perso=<?= $id_perso_session ?>&annee=<?= $annee ?>&mois=<?= $mois ?>" target="blank" style="margin-right: 20px"><i class="fa fa-print"></i> Imprimer
                                    </a>
                                </li>
                            </ul>
                        </b>
                        ...
                        <div class="table-responsive">
                            <table class="table table-border table-striped custom-table mb-0" id="dataTable">
                                ...
                                <tbody>
                                    ...
                                    $query = "SELECT  Count($id_type_service) as qte, $date_service[$i] as date_service, $id_type_service as id_type  FROM $service WHERE id_caisse = '$id_caisse' and  payer+remise = somme and year($date_service[$i]) = $annee and month($date_service[$i]) = $mois group by $date_service[$i] order by $date_service[$i] desc";
