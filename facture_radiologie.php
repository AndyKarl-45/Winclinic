...
$pdf->Text(22, $esp_init + 9, $id_reg_radiologie);
...
foreach ($id_medis as $id_med) {
    $pdf->SetFont('Arial', '', 7);
    $pdf->Text(67, $i, strtoupper(iconv('UTF-8', 'windows-1252', $nom_medi[$id_med])));
    $pdf->Text(117, $i, '1');
    $pdf->Text(124, $i,  $prix_ht[$id_med]);
    $pdf->Text(135, $i,  $prix_ht[$id_med]);
