                ...
                <form action="save_rapport_caisse.php" class="forms" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <?php
                                        echo '<input class="form-control" name="id_rap_caisse" type="hidden" value="'.$id_app.'">';
                    ...
                    <div class="form-steps">
                        <div class="input-groups">
                            ...
                            <input type="text" name="number_momo" id="position" placeholder="ex: 0666063502"/>
                        </div>
                        <div class="input-groups">
                            <label for="position">Montant: </label>
                            <input type="number" name="montant_momo" id="position" value="0"/>
                        </div>
                        <div class="input-groups">
                            <label for="position">Solde de commpte: </label>
                            <input type="number" name="solde_momo" id="position" value="0"/>
                        </div>
                    ...
                    <div class="form-steps">
                        <div class="input-groups">
                            <label for="position">Numéro de téléphone (OM): </label>
                            <input type="text" name="number_om" id="position" placeholder="ex: 0666063502"/>
                        </div>
                        <div class="input-groups">
                            <label for="position">Montant: </label>
                            <input type="number" name="montant_om" id="position" value="0"/>
                        </div>
                        <div class="input-groups">
                            <label for="position">Solde de commpte: </label>
                            <input type="number" name="solde_om" id="position" value="0"/>
                        </div>
                        <div class="btns-groups">
                            <a href="#" class="btns btn-prevs">Previous</a>
