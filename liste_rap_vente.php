    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid">
                <h1 class="mt-4"><i class="fas fa-tasks" style="color: silver"></i> Liste  des rapports de ventes</h1>
...
<!--                                    <th>PDF</th>-->
                                ...
                                while ($row = $q->fetch()) {
                                    ...
                                    <tr>
                                        <td><a href="details_rap_vente.php?id=<?=$id_caisse?>"><?=$code?></a></td>
                                        <td><a href="details_rap_vente.php?id=<?=$id_caisse?>"><?=$caisse?></a></td>
                                        <td><a href="details_rap_vente.php?id=<?=$id_caisse?>"><img width="28" height="28" src="assetss/img/user.jpg"
                                                                                                     class="rounded-circle m-r-5"
                                                                                                     alt=""><?=$nom?></a></td>
                                        <td><a href="details_rap_vente.php?id=<?=$id_caisse?>"><?= number_format($solde)?></a></td>
                                        <td><a href="details_rap_vente.php?id=<?=$id_caisse?>"><?=$date_caisse?></a></td>
                                        <td><a href="details_rap_vente.php?id=<?=$id_caisse?>"><?=$totalRemisesCaisse?></a></td>
