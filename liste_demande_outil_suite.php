    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid">
                <h1 class="mt-4"><i class="fas fa-random" style="color: silver"></i> Liste des demandes de fournitures</h1>
                    ...
                    <div class="col-xl-12">
                        ...
                        <b>
                            ...
                            <ul class="nav nav-pills" style="float: right;">
                                <li class="nav-item">
                                    <a class="btn btn-primary" href="nouvelle_demande_outils.php">
                    ...
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <table class="table table-border table-striped custom-table mb-0" id="dataTable">
                                <thead>
                                <tr>
                                    <th><p align="center">Demandeur</p></th>
                                ...
                                if($lvl!=3 and $lvl!= 5 and $lvl != 8 and $lvl!=9 and $lvl!=4 and $lvl!=7 and $lvl !=6){
                                    
                                    $query = "SELECT * from demande_outil WHERE id_perso = '$id_perso_session' and etat_src=0 and etat_dst=0  order by id_ask_outil desc";
                                    
                                }
                                switch ($lvl) {
                                    case '3';
                                    $query = "SELECT * from demande_outil WHERE id_nurse = '$id_perso_session' and etat_src=0 and etat_dst=0  order by id_ask_outil desc";   
                                        break;
                                    case '5';
                                    $query = "SELECT * from demande_outil WHERE id_med = '$id_perso_session' and etat_src=0 and etat_dst=0  order by id_ask_outil desc";   
                                        break;
                                    case '8';
                                    $query = "SELECT * from demande_outil WHERE id_chi = '$id_perso_session' and etat_src=0 and etat_dst=0  order by id_ask_outil desc";   
                                        break;
                                    case '9';
                                    $query = "SELECT * from demande_outil WHERE id_lab = '$id_perso_session' and etat_src=0 and etat_dst=0  order by id_ask_outil desc";   
                                        break;
                                }
                                
                                if($lvl == 4 || $lvl == 7 || $lvl==6){
                                    $query = "SELECT * from demande_outil where etat_src=0 and etat_dst=0  order by id_ask_outil desc";
                                }
                                            ...
                                            <?php
                                                ...
                                                if($etat!=1){
                                                    if($lvl == 10){
                                                        ...
                                                        echo' <a class="btn btn-primary" href="modifier_demande_outil.php?id='.$id_ask_outil.'"><i class="fa fa-pencil-alt"></i></a>||<a class="btn btn-primary" href="valider_demande_outil.php?idi='.$id_ask_outil.'"><i class="fa fa-check"></i></a>';
                                                    }
                                                }else{
