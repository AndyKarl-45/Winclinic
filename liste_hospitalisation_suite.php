    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-xl-12">
                         <?php if ( $lvl !=11 and $lvl  !=2 and $lvl  !=3) { ?>

                        <b>
                            <ul class="nav nav-pills" style="float: right; margin-right: 20px ;">
                            <li class="nav-item">
                                <a class="btn btn-primary" href="liste_hospitalisation.php">
...
//                                }
                                ...
                                <tr align="center">
                                    ...
                                    <td><a href="#"><?=$nom_lit?></a></td>
                                    <td><a href="#"><?=$nb_jour?></a></td>
                                    <td><a href="#"><?= dateToFrench($date_hosp, " j F Y")?></a></td>
                                    <td><a href="#"><?= dateToFrench($date_sortie, " j F Y")?></a></td>
                                    <td class="text-right">
