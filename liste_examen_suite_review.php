          ...
          <div class="table-responsive">
            <table class="table table-border table-striped custom-table mb-0" id="dataTable">
              ...
              <tbody>
                ...
                $query = "SELECT * from regler_examen order by id_reg_exa desc";
                $q = $db->query($query);
                while ($row = $q->fetch()) {
                ...
                ?>
                  ...
                  <tr>
                    ...
                    <td align="center">
                      <!-- <a
                        href="facture_examen_A4.php?id_reg_exa=<?= $id_reg_exa ?>&id_perso=<?= $id_perso_session ?>" title="Format A4"
                        target="_blank">
                        <i class='fa fa-print'></i>
                      </a> -->
                      <a
                        href="facture_examen_A5.php?id_reg_exa=<?= $id_reg_exa ?>&id_perso=<?= $id_perso_session ?>" title="Format A5"
                        target="_blank">
                        <i class='fa fa-print'></i>
                      </a>
                      <!--                                            <a-->
                      <!--                                                    href="facture_examen_A6.php?id_reg_exa=--><?php //= $id_reg_exa 
                      ...
                      <!--                                            </a>-->
                      <a
                        href="facture_examen_Ticket.php?id_reg_exa=<?= $id_reg_exa ?>&id_perso=<?= $id_perso_session ?>" title="Ticket"
                        target="_blank">
                    ...
                    <td class="text-center">
                      ...
                      if ($lvl == 4 ||  $lvl == 13) {
                        if ($lvl == 11 || $lvl == 7 || $lvl == 12) {
                          ...
                          if ($etat_reg == 1) {
                            echo '<a href="rembourser_exa.php?id_exa=' . $id_exa . '&id_reg_exa=' . $id_reg_exa . '" onclick="Supp(this.href); return(false);"><span class="custom-badge status-blue" ">rembourser</span></a>';
                          }
                        }
                      }
                        ...
                        <div class="modal-dialog" style="max-width: 800px; !important">
                          ...
                          <div class="modal-content" style="width: 800px; !important">
                            ...
                            <div class="modal-body" style="padding:40px 50px;">
                              <form class="form-horizontal" action="update_exa_paye.php" name="form" method="post">
                                  ...
                                  <table style="width: 100%;">
                                    ...
                                    <tfoot>
                                      <tr>
                                        ...
                                        <th>
                                          <input type="hidden" name="montant_total" class="total-<?= $ref_exa ?>" value="0">
                                          <input type="text" style="width: 100px;" id="montant-total<?= $ref_exa ?>" value="0" disabled>
                                        </th>
                                      </tr>
                                      <tr>
                                        <th colspan="3">Montant versé:</th>
                                        <th>
                                          <input type="text" style="width: 100px;" name="montant_verse" id="montant-verse<?= $ref_exa ?>" style="background-color: #dee2e6" value="0" oninput="calculerReste('<?= $ref_exa ?>')">
                                        </th>
                                      </tr>
                                      <tr>
                                        <th colspan="3" style="background-color:white;">Reste à rembourser:</th>
                                        <th>
                                          <input type="text" style="width: 100px;" id="reste-rembourser<?= $ref_exa ?>" value="0" disabled>
                                        </th>
                                      </tr>
                                      <tr>
                                        <th colspan="3">Reste à payer:</th>
                                        <th>
                                          <input type="text" style="width: 100px;" id="reste-payer<?= $ref_exa ?>" value="0" disabled>
                                        </th>
                                      </tr>
                                      <?php
                                      if ($lvl != 2) {
                                    ...
                                    <tbody>
                                      <?php
                                      if ($etat_reg != 0)
                                        $sql = "SELECT * from examen_exa  where ref_exam_exa = '$ref_exa' and etat!=0";
                                      else
                                      ...
                                      ?>
                                        <tr align="center">
                                          ...
                                          <td><input type="checkbox" class="choix" style="transform: scale(1.5);" name="id_type_exa[]" value="<?= $id_type_exa ?>"
                                              data-total="<?php echo $prix - $payer_exa; ?>" data-id="<?= $ref_exa ?>" <?php if ($prix - $payer_exa == 0) {
                                                                                                                          echo 'disabled';
                                                                                                                        } ?>></td>
                                        </tr>
                                      <?php } ?>
...
<script>
  function Supp(link) {
    if (confirm('Confirmer  le remboursement de l\'examen ?')) {
...
<script>
  $(document).ready(function() {
    $('#dataTable').DataTable({
      "order": [
        [0, "desc"]
      ] // Trie la colonne Date (index 0) par ordre décroissant
    });
  });
</script>
