        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-xl-12">
                    ...
                    <?php if ($lvl != 8 and $lvl != 11  and $lvl != 3) { ?>
                        <b>
                            <!-- Nav pills -->
                        ...
                        <ul class="nav nav-pills" style="float: right; margin-right: 20px ;">
                            <li class="nav-item">
                                <a class="nav-link" href="liste_operation_suite.php">

                                    <?php


                                    $query = "SELECT count(DISTINCT ref_ope) as total from operation where open_close!=1";
                                    ...
                                    $q = $db->query($query);
                                    while ($row = $q->fetch()) {
                                        echo ' Opération en cours [' . $row['total'] . ']';
                                    }
