                                            ...
                                            <div class="col-xl-12">
                                                <div class="card mb-4">
                                                    <div class="card-header">
                                                        ...
                                                        <ul class="nav nav-pills"   style="float: right;">
                                                            <li class="nav-item">
                                                                <a class="nav-link active" href="ajouter_medi_ordo.php?ref_ordo=<?=$ref_ordo?>">
                                                                    <i class="fas fa-cubes"></i>
                                                                    Ajouter médicament
                                                                </a>
                                                            </li>
                                                                                ...
                                                                                foreach($tables as $table)
                                                                                {
                                                                                    ...
                                                                                    while($row = $q->fetch())
                                                                                    {
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            //                                                                                                ?><!--  </td>-->
                                                                                            <td align="center">
                                                                                                <a class="btn btn-warning" data-toggle="modal" data-target="#modifierMediOrdo<?=$id_medi_ordo?>"  title="Modifier"
                                                                                                   style="background-color: transparent">
                                                                                                    <i style="color: orange" class="fas fa-pen"></i>
                                                                                                </a>

                                                                                                <a class="btn btn-danger"  href="delete_medi_ordo.php?ref_ordo=<?php echo $ref_ordo; ?>&id_medi=<?=$id_medi?>" title="view"
                                                                                                   style="background-color: transparent">
                                                                                                ...
                                                                                                <div class="modal fade" id="modifierMediOrdo<?=$id_medi_ordo?>" role="dialog">
                                                                                                    <div class="modal-dialog">
                                                                                                        <!-- Modal content-->
                                                                                                        <div class="modal-content">
                                                                                                            <div class="modal-header" style="padding:20px 50px;">
                                                                                                                <h3 align="center"><i class="fas fa-map"></i> <b>Médicaments: <?=$designation?></b></h3>
                                                                                                                <button type="button" class="close" data-dismiss="modal" title="Close">&times;</button>
                                                                                                            </div>
                                                                                                            <div class="modal-body" style="padding:40px 50px;">
                                                                                                                <form class="form-horizontal" action="update_medi_ordo.php" name="form" method="#">

                                                                                                                    <div class="form-group">
                                                                                                                        <input type="hidden" name="ref_ordo" value="<?=$ref_ordo?>">
                                                                                                                        <input type="hidden" name="id_medi" value="<?=$id_medi?>">
                                                                                                                        <label>Quantité(s):</label>
                                                                                                                        <div class="col-sm-12">
                                                                                                                          <input type="number" name="qte" value="<?=$quantite?>">
                                                                                                                        </div>
                                                                                                                    </div>
