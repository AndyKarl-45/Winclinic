                                    ...
                                    <div class="col-lg-8 offset-lg-2">
                                        <form action="save_depense_caisse.php" method="POST">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="id_caisse">
                                                            ...
                                                            if ($lvl == 2) {
                                                                $iResult = $db->query("SELECT * FROM caisse where id_perso=$id_perso_session ");
                                                            } else {
                                            ...
                                            <div class="m-t-20 text-center">
                                                ...
                                                <a href="<?= $depense_caisse['option2_link'] ?>" style=" width:150px;" class="btn btn-danger">
                                                    <font>Annuler</font>
                                                </a>
                                            </div>
                                        </form>
