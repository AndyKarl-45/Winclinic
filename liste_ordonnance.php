                ...
                <div class="col-xl-12">
                    ...
                    <b>
                        ...
                        <ul class="nav nav-pills" style="float: right; margin-right: 20px ;">
                            <li class="nav-item">
                                <a class="nav-link" href="liste_ordonnance_suite_review.php">

                                    <?php

                                    echo ' Ordonnance à régler';
                        ...
                        <ul class="nav nav-pills" style="float: right; margin-right: 20px ;">
                            <li class="nav-item">
                                <a class="nav-link" href="liste_ordonnance_suite.php">
                                    ...
                                    if ($lvl == 5) {
                                        $query = "SELECT DISTINCT count(id_ordo) as total from ordonnance WHERE id_medecin = '$id_perso_session' and etat=0 and affiche!=0";
                                    } else {
                                        $query = "SELECT DISTINCT count(id_ordo) as total from ordonnance where etat=0 and affiche!=0 ";
                                    }
                        ...
                        <table class="table table-border table-striped custom-table mb-0" id="dataTable">
                            <thead>
                                <tr>
                                    ...
                                    <!--                                    <th>Statuts</th>-->
                                    <th>PDF</th>
                                    <?php if ($lvl != 10 and $lvl != 11 and $lvl != 2) { ?>
                            ...
                            <tbody>
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <!--<td>observations</td>-->
                                        <td><?= dateToFrench($date_ordo, " j F Y") ?></td>
                                        <!--                                    <td><span class="custom-badge status-red">Impayer</span></td>-->
                                        <td align="center"><a href="etat_print_liste_ordo.php?ref_ordo=<?= $ref_ordo ?>" target="_blank">
                                            ...
                                            <td class="text-right">
                                                <div class="dropdown dropdown-action">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        ...
                                                        <a class="dropdown-item" href="modifier_ordonnance.php?ref_ordo=<?= $ref_ordo ?>"><i
