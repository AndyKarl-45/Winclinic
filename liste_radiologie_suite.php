    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid">
                <h1 class="mt-4"><i class="fas fa-users" style="color: silver"></i> Liste des Radiologies en cours de paiement</h1>
                ...
                <div class="row">
                    <div class="col-xl-12">
                        ...
                        <ul class="nav nav-pills" style="float: right; margin-right: 20px ;">
                            <li class="nav-item">
                                <a class="btn btn-primary" href="liste_radiologie.php">
...
<!--                                    <th>Réferences</th>-->
                                ...
                                <?php
                                // if ($lvl == 14) {
                                //     $query = "SELECT * from radiologie where id_radiologue='$id_perso_session' and etat=0";
                                // } elseif($lvl == 5){
                                //     $query = "SELECT * from radiologie where id_medecin='$id_perso_session' and etat=0";
                                // }else {

                                    $query = "SELECT * from radiologie where etat=0";
                                ...
                                while ($row = $q->fetch()) {
                                    ...
                                    <tr>
<!--                                        <td><a href="#">--><?php //=$ref_radiologie?><!--</a></td>-->
                                        ...
                                        <td><a href="#"><?=$nom_radiologue?></a></td>
                                        <td><a href="#"><?= dateToFrench($date_radiologie, " j F Y")?></a></td>
                                        <td>
                                         ...
                                         <td align="center"><a href="etat_print_liste_radiologie.php?ref_radiologie=<?=$ref_radiologie?>" target="_blank">
