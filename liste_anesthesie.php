                ...
                <div class="col-xl-12">
                    ...
                    ?>
                        ...
                        <ul class="nav nav-pills" style="float: right; margin-right: 20px ;">
                            <li class="nav-item">
                                <a class="nav-link" href="liste_anesthesie_suite.php">

                                    <?php
                                    $query = "SELECT count(DISTINCT ref_anes) as total from anesthesie where open_close!=1";
                                    ...
                                    $q = $db->query($query);
                                    while ($row = $q->fetch()) {
                                        echo ' Anesthésie en cours [' . $row['total'] . ']';
                                    }
