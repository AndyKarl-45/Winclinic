...
//    $region = $_POST['region'];
    ...
    $query1 = " UPDATE patient SET  nom_p=:nom_p, prenom_p=:prenom_p, username_p=:username_p, age_p=:age, email_p=:email_p, 
        genre_p=:genre_p, date_aniv_p=:date_aniv_p, adresse_p=:adresse_p,  phone_p=:phone_p, ville_p=:ville_p,  pays_p=:pays_p, biography_p=:biography_p, id_ent=:id_ent, id_ass=:id_ass, pers=:pers, pers_tel=:pers_tel    WHERE id_patient = '$id' ";
...
//    $sql1->bindParam(':region_p', $region);
    ...
    $sql1->bindParam(':pers', $pers);
    $sql1->bindParam(':pers_tel', $pers_tel);
    $sql1->execute();
