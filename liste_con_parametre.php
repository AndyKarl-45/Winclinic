    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid">
                <h1 class="mt-4"><i class="fas fa-heartbeat" style="color: silver"></i> Liste des consultations (Paramètres)</h1>
                ...
                <div class="row">
                    <div class="col-xl-12">
                        ...
                        <b>
                            <!-- Nav pills -->
                            <?php
                        if( $lvl != 1 and  $lvl != 11 and $lvl!=5 and $lvl!=2  and $lvl!=3   ){
                        ?>
                            ...
                            <ul class="nav nav-pills" style="float: right; margin-right: 20px ;">
                                <li class="nav-item">
                                    <a class="btn btn-primary" href="liste_consultation.php">
...
<!--                                    <th>Code Patient</th>-->
                                ...
                                <?php
                                    ...
                                    $query = "SELECT * from consultation where etat=1 and open_close!=1";
