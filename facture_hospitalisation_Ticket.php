...
$id_reg_hosp=$_REQUEST['id_reg_hosp'];
...
//    Tes requetes
    ...
    $sql = "SELECT * from regler_hosp where id_reg_hosp = '$id_reg_hosp'";
    ...
    foreach ($tables as $table) {
        $ref_reg_hosp = $table['ref_reg_hosp'];
...
foreach ($id_medis as $id_med){
    $pdf->SetFont('Arial','',6);
    $pdf->Text(2, 78+$i, strtoupper($type_hosp));
    $pdf->Text(45, 78+$i, '1');
