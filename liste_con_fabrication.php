...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid">
            <h1 class="mt-4"><i class="fas fa-heartbeat" style="color: silver"></i> Liste des consultations en cours</h1>
                    ...
                    <div class="table-responsive">
                        <table class="table table-border table-striped custom-table mb-0" id="dataTable">
                            ...
                            <tbody>
                                <?php
                                if ($lvl == 5) {
                                    $query = "SELECT * from consultation where (id_medecin='$id_perso_session') or id_medecin=0  and etat=2 and open_close!=1";
                                } elseif ($lvl == 3) {
                                    $query = "SELECT * from consultation where id_nurse='$id_perso_session' or id_nurse=0 and etat=2 and open_close!=1";
                                } else {

                                    $query = "SELECT * from consultation where etat=2 and open_close!=2";
                                }
