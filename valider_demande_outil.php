...
foreach($tables as $table)
{
    ...
    $sql = "SELECT * FROM magasin_outil where id_outil='$id_materiel' and  id_num_lot_outil LIKE '$id_num_lot_outil' ";
    $stmt = $db->prepare($sql);
    $stmt->execute();
...
$heure=date("G:i");
$query  = " UPDATE demande_outil  SET   etat_src=:etat, date_valide=:date_valide, heure_debut=:heure    
...
$etat_t=0;
$post=0;
$query  = " UPDATE demande_materiel_outil  SET   etat_src=:etat, etat_dst=:etat_t  WHERE id_ask_outil='$id_ask_outil'";
