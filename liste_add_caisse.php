                                                ...
                                                <form method="post" action="">
                                                    <table class="table table-bordered table-hover" id="dataTable"
                                                        ...
                                                        <tr class="bg-primary">
                                                            ...
                                                            <th><p align="center" style="color: white">Type de caisse</p></th>
                                                        ...
                                                        while ($row = $q->fetch()) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="center"><b class="<?=$btn?>" style="background-color: transparent; width: 160px; color: <?=$color?>"><?=$type_caisse?></b></td>
