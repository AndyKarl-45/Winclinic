                            ...
                            <table class="table table-border table-striped custom-table mb-0" id="dataTable">
                                ...
                                <tbody>
                                    ...
                                    while ($row = $q->fetch()) {
                                        ...
                                        if ($nom_service != 'Examen') {
                                            $lien = "details_rap_rapport_service.php";
                                        } else {
                                            $lien = "details_rap_vente_exa_service.php";
                                        }
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            <td><a href="<?= $lien ?>?id=<?= $id_caisse ?>&service=<?= $table_service ?>"><img width="28" height="28" src="assetss/img/user.jpg"
