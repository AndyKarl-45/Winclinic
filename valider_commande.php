...
$sql="SELECT *  FROM commande where ref_com='$ref_com'  and id_four='$id_four'and etat=1 ";
            ...
            foreach($tables as $table)
            {
              ...
              //  $prix=$table['prix_ht'];
                ...
                // $sql="SELECT qt_com FROM magasin where id_num_lot='$id_num_lot' and ref_com='$ref_com' ";
                $sql="SELECT qt_com FROM magasin where id_num_lot='$id_num_lot' and id_medi ='$id_medi' ";
            $stmt = $db->prepare($sql);
            $stmt->execute();
            ...
            if($total!=0){
             $qt_total=$quantite+$qt;
                ...
                $query1 = "UPDATE magasin SET qt_com=:qt_com where id_num_lot='$id_num_lot' and id_medi ='$id_medi'";
            ...
            //     $query = " INSERT INTO magasin (id_four,ref_com,id_medi,qt_com,date_c_com,date_l_com,date_r_com,id_num_lot,date_exp,date_fab)
            //          VALUES (:id_four,:ref_com,:id_medi,:qt_com,:date_c_com,:date_l_com,:date_r_com,:id_num_lot,:date_exp,:date_fab)";
