...
$filename = "etat_stock_aletr_phar_".$heure.".xls";
   ...
   <?php
    ...
    $type_medi= $table['nom'];
        ...
        <tr align="center">
            ...
            <!--                                                            IRPP-->
            <td><?php echo $prix_u_a*$quantite?></td>
            <td><?php echo $prix_u_v*$quantite?></td>
            <td><?php echo ($prix_u_v*$quantite)-($quantite*$prix_u_a)?></td>
