    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid">
                <h1 class="mt-4">Fiche de Vaccination</h1>
                                                    ...
                                                    <div class="card-body">
                                                        <fieldset>
                                                            <div class="table-responsive">
                                                                <form action="save_vaccination.php" method="POST" enctype="multipart/form-data">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div>
                                                                                    <input type="date" class="form-control" name="date_vaccin">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-6">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div>
                                                                                    <input type="date" class="form-control" name="date_next_vaccin">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
