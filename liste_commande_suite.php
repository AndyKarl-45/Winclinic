                    ...
                    <div class="table-responsive">
                        <table class="table table-border table-striped custom-table mb-0" id="dataTable">
                            ...
                            <tbody>
                                ...
                                $query = "SELECT distinct ref_com from commande where etat=0  ";
                                $q = $db->query($query);
                                while ($row = $q->fetch()) {
                                    $ref_com = $row['ref_com'];
                                    ...
                                    //count(DISTINCT id_medi) as total,

                                    //  $sql = "SELECT   id_com,id_four,frais,date_c_com,etat from commande where ref_com = '$ref_com' ";
                                    $sql = "SELECT  id_com, id_four, frais, date_c_com, etat ,obs
            FROM commande 
            WHERE ref_com = '$ref_com' LIMIT 1";
                                ...
                                ?>
                                        ...
                                        <tr>
                                            ...
                                            <!--                                        <td><a href="#">--><?php //=number_format($total)
                                                                                                            ?><!--</a></td>-->
                                            <td><a href="#"><?= $obs ?></a></td>
