...
$query  = "SELECT count(id_eco) as total from ecographie";
$q = $conn->query($query);
...
$id_entite = $total + 1;
$ref_entite = 'ECO_'.$year.'_'.$month.'_'.$id_entite;
?>
    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid">
                <h1 class="mt-4">Fiche d'écographie</h1>
                            ...
                            <div class="card-header">
                                <b>
                                    ...
                                    <ul class="nav nav-pills" style="float: right;">
                                        <li class="nav-item">
                                            <a class="nav-link active" href="<?= $ecographie['option2_link'] ?>">
                                                    ...
                                                    <div class="card-body">
                                                        <fieldset>
                                                            <div class="table-responsive">
                                                                <form action="save_ecographie.php" method="POST" enctype="multipart/form-data">
<!--                                                                    <div class="col-lg-8 offset-lg-2">-->
                                                                    <input type="hidden" name="partie" value="1">
                                                                    <input type="hidden" name="ref_eco" value="<?=$ref_entite?>">
                                                                    <input type="hidden" name="id_eco" value="<?=$id_entite?>">
                                                                                        ...
                                                                                        <?php if($lvl == 5){ ?>
                                                                                            ...
                                                                                            <div class="tab-content">
                                                                                                <div class="tab-pane  active" id="a1">
                                                                                                    ...
                                                                                                    <select class="form-control" name="id_medecin1" id="countriesMed">
                                                                                        ...
                                                                                        <?php }elseif($lvl == 3){ ?>
                                                                                            ...
                                                                                            <div class="tab-content">
                                                                                                <div class="tab-pane  active" id="a3">
                                                                                                    ...
                                                                                                    <input type="hidden" class="form-control" name="id_medecin1" value="0">
                                                                                            ...
                                                                                            <div class="col">
                                                                                                ...
                                                                                                <div class="tab-content">
                                                                                                    <div class="tab-pane  active" id="a1">
                                                                                                        ...
                                                                                                        <div class="col">
                                                                                                            <input type="search" class="form-control" placeholder="barre de recherche..." id="searchBoxMed" >
                                                                                                            <select name="id_medecin1"  class="form-control"  id="countriesMed">
...
<!--                                                                    </div>-->
                                                                    ...
                                                                    <div class="card mb-4">
                                                                        <div class="card-header">
                                                                            ...
                                                                            <b>Liste des écographies </b>
                                                                        </div>
                                                                    </div>
                                                                    <div class="table-responsive">
                                                                        <table class="table table-border table-striped custom-table mb-0" id="TableIDEco" >
                                                                            <thead>
                                                                            <tr>
                                                                                <th>...</th>
                                                                            ...
                                                                            <tr class="search-group" id="search-group-0">
                                                                                ...
                                                                                <td>
                                                                                    <input type="search" id="searchBoxTypeEco-0" class="form-control " placeholder="barre de recherche..."  spellcheck="false">
                                                                                    <select class="form-control " id="countriesTypeEco-0"
                                                                                            name="id_type_eco[]"  >
                                                                                        <?php
                                                                                        ...
                                                                                        while ($row = $q->fetch()) {
                                                                                            ...
                                                                                            echo '<option value ="' . $id_type_eco . '">';
                                                                                            echo $row['nom'].' ('.$prix_t_eco.') FCFA';
                                                                                            echo '</option>';
                                                                                ...
                                                                                <td>
                                                                                    <a type="button"  onclick="addRow('TableIDEco')"
                                                                                       class="btn btn-primary"
                                                                                       title="view"
                                                                                       style="background-color: transparent">
                                                                                        <i style="color: green" class="fas fa-plus"></i>
                                                                                    </a>
                                                                                    <a class="btn btn-danger" type="button" onclick="deleteRow('TableIDEco')"
                                                                                       title="supprimer"
                                                                                       style="background-color: transparent">
                                                                    ...
                                                                    <div class="m-t-20 text-center">
                                                                        ...
                                                                        <a href="<?=$ecographie['option2_link']?>" style=" width:150px;" class="btn btn-danger"><font>Annuler</font></a>
                                                ...
                                                <div class="card mb-4">
                                                    ...
                                                    <div class="card-body">
                                                        <fieldset>
                                                            <div class="table-responsive">
                                                                <div class="col-lg-8 offset-lg-2">
                                                                    <form action="save_ecographie.php" method="POST">
                                                                        <div class="row">
                                                                            <div class="col-sm-6">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input type="search" class="form-control" placeholder="barre de recherche..." id="searchPatEco" >
                                                                                    <select class="form-control"
                                                                                            name="id_patient" id="countriesPatEco"
                                                                            ...
                                                                            <div class="col-sm-6">
                                                                                <div class="form-group">
                                                                                    <label>Médecin<span
                                                                                                class="text-danger">*</span></label>
                                                                                    <input type="search" class="form-control" placeholder="barre de recherche..." id="searchBoxMediEco" >
                                                                                    <select class="form-control" name="id_medecin2" id="countriesMediEco">
