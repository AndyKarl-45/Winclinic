                    ...
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <table class="table table-border table-striped custom-table mb-0" id="dataTable">
                                ...
                                <?php
                                if($lvl == 2)
                                    $query = "SELECT * FROM transfert_caisse WHERE etat=0 AND (id_perso_src='$id_perso_session' OR (id_perso_dst='$id_perso_session' AND open_close!=1))";

                                else
                                $query = "SELECT *from transfert_caisse where etat=0 and open_close!=1";
                                            ...
                                            <td>
                                                ...
                                                if($lvl==2){
                                                    if($id_perso_session == $id_perso_dst) {
                                                        if ($etat != 1) {
                                                            if($lvl ==2) {
                                                                echo ' <a class="btn btn-primary" href="valider_transfert_caisse.php?id_caisse_src=' . $id_caisse_src . '&id_caisse_dst=' . $id_caisse_dst . '&quantite=' . $quantite . '&id_trans_caisse=' . $id_trans_caisse . '">
                                                ...
                                                ';
                                                    ...
                                                    if($id_perso_session ==$id_perso_session) {
                                                        if ($etat != 1) {
                                                            ...
                                                            if($lvl ==2){
                                                                echo ' <a class="btn btn-primary" href="valider_transfert_caisse.php?id_caisse_src=' . $id_caisse_src . '&id_caisse_dst=' . $id_caisse_dst . '&quantite=' . $quantite . '&id_trans_caisse=' . $id_trans_caisse . '">
                                                         <i class="fa fa-check"></i></a>||<a class="btn btn-danger"  onclick="Supp(this.href); return(false);" href="delete_transfert_caisse.php?id_trans_caisse=' . $id_trans_caisse . '" >
                                                         <i class="fa fa-window-close"></i></a>';
                                                            }else{
                                                                echo ' <a class="btn btn-warning" href="modifier_transfert_caisse.php?id_trans_caisse=' . $id_trans_caisse . '">
                                                         <i class="fa fa-pencil-alt"></i></a>||<a class="btn btn-primary" href="valider_transfert_caisse.php?id_caisse_src=' . $id_caisse_src . '&id_caisse_dst=' . $id_caisse_dst . '&quantite=' . $quantite . '&id_trans_caisse=' . $id_trans_caisse . '">
