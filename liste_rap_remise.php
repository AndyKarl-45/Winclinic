...
<!--                                    <th>PDF</th>-->
                                ...
                                while ($row = $q->fetch()) {
                                    ...
                                    <tr>
                                        <td><a href="details_rap_remise.php?id=<?=$id_caisse?>"><?=$code?></a></td>
                                        <td><a href="details_rap_remise.php?id=<?=$id_caisse?>"><?=$caisse?></a></td>
                                        <td><a href="details_rap_remise.php?id=<?=$id_caisse?>"><img width="28" height="28" src="assetss/img/user.jpg"
                                                                                                     class="rounded-circle m-r-5"
                                                                                                     alt=""><?=$nom?></a></td>
                                        <td><a href="details_rap_remise.php?id=<?=$id_caisse?>"><?= number_format($solde)?></a></td>
                                        <td><a href="details_rap_remise.php?id=<?=$id_caisse?>"><?=$date_caisse?></a></td>
                                        <td><a href="details_rap_remise.php?id=<?=$id_caisse?>"><?=$totalRemisesCaisse?></a></td>
