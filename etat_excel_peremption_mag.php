...
$filename = "etat_peremption_mag_".$heure.".xls";
...
<table class="table table-bordered"  border="1">
    ...
    while($row = $q->fetch())
    {
        ...
        <tr align="center">
            ...
            <!--                                                            Base-->
            <td><?php echo $qt_com ?></td>
            <td><?php echo iconv( 'UTF-8' ,'Windows-1252', $type_medi);?> </td>
            <!--                                                            IRPP-->
            <td><?php echo $prix_u_a*$qt_com?></td>
            <td><?php echo $prix_u_v*$qt_com?></td>
            <td><?php echo ($prix_u_v*$qt_com)-($qt_com*$prix_u_a)?></td>
