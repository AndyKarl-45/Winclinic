...
?>
<?php
$id_service = $_REQUEST['service'];
$annuel = $_REQUEST['annuel'];
  ...
  <div id="layoutSidenav_content">
    <main>
      <div class="container-fluid">
        <h1 class="mt-4"><i class="fas fa-tasks" style="color: silver"></i> Details de la vente: <?= $nom_service ?> de l'année <?= $annuel ?></h1>
          ...
          <div class="col-xl-12">
            <b>
              ...
              <ul class="nav nav-pills" style="float: right;">
                <li class="nav-item">
                  <a class="nav-link active" href="etat_print_vente.php?id_service=<?= $id_service ?>" target="blank" style="margin-right: 20px"><i class="fa fa-print"></i> Imprimer
                  </a>
                </li>
              </ul>
            ...
            <div class="table-responsive">
              <table class="table table-border table-striped custom-table mb-0" id="dataTable">
                ...
                <tbody>
                  ...
                  $query = "SELECT * from historique_caisse where service='$id_service' and YEAR(date_hist) = $annuel order by id_hist_caisse desc";
                  ...
                  ?>
                    ...
                    <tr>
                      ...
                      <td><a href="#"><?= $montant_entre ?></a></td>
                      <td><a href="#"><?= $montant_sortie ?></a></td>
                      <td><a href="#"><?= dateToFrench($date_hist, " j F Y") ?></a></td>
                      <td><a href="#"><?= $statut ?></a></td>
                      <td><a href="#"><?= $statut_nom ?></a></td>
                      <td><a href="#"><?php $sql = "SELECT * from mode_paie where id_mode_paie = '$id_mode_paie' and open_close!=1";
