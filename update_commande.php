...
if ($_POST) {
    ...
    $query1 = " UPDATE commande SET  id_four=:id_four, date_c_com=:date_c_com   WHERE ref_com = '$ref_com' ";
    ...
    if ($sql1) {
        ...
        <script>
            ...
            window.location.href = 'modifier_commande.php?ref_com=<?=$ref_com?>&witness=1';
        </script>
        <?php
    } else {
        ?>
