    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid">
                <h1 class="mt-4">Nouvelle Fourniture</h1>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-8 offset-lg-2">
                                            <form action="save_outil.php" method="POST">
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" name="id_type_outil">
                                                                <option value="0">...</option>
                                                                <?php

                                                                $iResult = $db->query("SELECT * FROM type_outil ");

                                                                while ($data = $iResult->fetch()) {

                                                                    $i = $data['id_type_outil'];
                                                                    echo '<option value ="' . $i . '">';
                                                                    echo $data['nom'];
                                                                    echo '</option>';
