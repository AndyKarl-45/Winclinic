...
//    Tes requetes
   ...
   if($lvl == 10)
        $sql = "SELECT * from demande_medicament WHERE id_perso = '$id_perso' and etat_dst=1 and etat_src=1 order by id_ask_medi desc";
    else
        $sql = "SELECT * from demande_medicament where etat_dst=1 and etat_src=1 order by id_ask_medi desc";
