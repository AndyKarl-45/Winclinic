...
$pdf->Text(55, 40, 'CLINIQUE CATHOLIAUE SAINTE MARIE');
...
foreach ($id_medis as $id_med) {
  $pdf->SetFont('Arial', '', 8);
  $pdf->Text(103, 35.5 + $i, strtoupper($autre_service[$id_med]));
  $pdf->SetFont('Arial', '', 8);
  $pdf->Text(158, 35.5 + $i, '1');
  $pdf->Text(168, 35.5 + $i, $amount[$id_med]);
  $pdf->Text(185, 35.5 + $i, $amount[$id_med]);
