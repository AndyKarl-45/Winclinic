                            ...
                            <ul class="nav nav-pills"   style="float: right; margin-right: 20px ;">
                                <li class="nav-item">
                                    <a class="btn btn-primary" href="liste_transfert_caisse.php">
                                        ...
                                        if($lvl == 2){
                                            $query = "SELECT count(id_trans_caisse) as total FROM transfert_caisse WHERE etat=1 AND (id_perso_src='$id_perso_session' OR (id_perso_dst='$id_perso_session' AND open_close!=1))";
                                        }else{
                            ...
                            <ul class="nav nav-pills"   style="float: right; margin-right: 20px ;">
                                <li class="nav-item">
                                    <a class="btn btn-primary" href="liste_transfert_caisse_suite.php">
                                        ...
                                        if($lvl == 2){
                                            $query = "SELECT count(id_trans_caisse) as total FROM transfert_caisse WHERE etat=0 AND (id_perso_src='$id_perso_session' OR (id_perso_dst='$id_perso_session' AND open_close!=1))";
                                        }else{
                            ...
                            <table class="table table-border table-striped custom-table mb-0" id="dataTable">
                                ...
                                while ($row = $q->fetch()) {
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="details_tresorerie.php?id=<?=$id_caisse?>"><?=$totalRemisesCaisse?></a></td>
