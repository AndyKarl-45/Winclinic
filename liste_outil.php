    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid">
                <h1 class="mt-4"><i class="fas fa-users" style="color: silver"></i> Liste des Fournitures</h1>
                    ...
                    <div class="col-xl-12">
                        ...
                        <b>
                            ...
                            <ul class="nav nav-pills" style="float: right;">
                                <li class="nav-item">
                                    <a class="btn btn-primary" href="nouvelle_outil.php">
                    ...
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <table class="table table-border table-striped custom-table mb-0" id="dataTable">
                                ...
                                $query = "SELECT * from outil where open_close!=1";
                                $q = $db->query($query);
                                while ($row = $q->fetch()) {
                                ...
                                $prix_u_a = $row['prix_unit'];
                                $prix_u_v = $row['prix_u_v'];
                                $date_fin = $row['date_create'];
                                $id_four = $row['id_four'];

                                $solde+=$prix_u_a;
                                $solde_vente+=$prix_u_v;
                                    ...
                                    <td class="text-right">
                                        <div class="dropdown dropdown-action">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a class="dropdown-item" href="modifier_prod.php?id=<?=$id_outil?>"><i
                                                            class="fas fa-pen"></i> Edit</a>
                                                <a class="dropdown-item" href="delete_prod_prod.php?id=<?=$id_outil?>" onclick="Supp(this.href); return(false);"><i class="fas fa-trash"></i>
                                                    Delete</a>
                                            </div>
                                             <?php
                                            }
