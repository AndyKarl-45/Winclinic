                ...
                <div class="col-xl-12">
                    <b>
                        ...
                        <ul class="nav nav-pills" style="float: right; margin-right: 20px ;">
                            <li class="nav-item">
                                <a class="nav-link active" href="liste_examen_suite_review.php">

                                    <?php
                                    echo ' Examen à régler';
                    ...
                    <div class="table-responsive">
                        <table class="table table-border table-striped custom-table mb-0" id="dataTable">
                            ...
                            <tbody>
                                ...
                                $query = "SELECT * from regler_examen where DATE(date_reg_paie) >= CURDATE()";
                                $q = $db->query($query);
                                while ($row = $q->fetch()) {
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            <!--                                            <a-->
                                            <!--                                                    href="facture_examen_A4.php?id_reg_exa=--><?php //= $id_reg_exa 
