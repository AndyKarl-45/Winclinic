                ...
                <div class="col-xl-12">
                    ...
                    ?>
                        <b>
                            ...
                            <ul class="nav nav-pills" style="float: right;">
                                <li class="nav-item">
                                    <a class="btn btn-primary" href="nouveau_examen.php">
                    ...
                    <b>
                        ...
                        <ul class="nav nav-pills" style="float: right; margin-right: 20px ;">
                            <li class="nav-item">
                                <a class="nav-link" href="liste_examen_suite_review.php">
                        ...
                        <ul class="nav nav-pills" style="float: right; margin-right: 20px ;">
                            <li class="nav-item">
                                <a class="nav-link" href="liste_examen_suite.php">

                                    <?php
                                    if ($lvl == 3) {
                                        $query = "SELECT DISTINCT count(id_exa) as total from examen WHERE id_nurse = '$id_perso_session' and etat=0 and open_close!=1";
                                    } elseif ($lvl == 5) {
                                        $query = "SELECT DISTINCT count(id_exa) as total from examen WHERE id_medecin = '$id_perso_session' and etat=0 and open_close!=1";
                                    } else {
                                        $query = "SELECT DISTINCT count(id_exa) as total from examen where etat=0 and open_close!=1 ";
                                    }

                                    $q = $db->query($query);
                                    while ($row = $q->fetch()) {
                                        echo ' Examen en cours de paiement[' . $row['total'] . ']';
                                    }
                    ...
                    <div class="table-responsive">
                        <table class="table table-border table-striped custom-table mb-0" id="dataTable">
                            ...
                            <tbody>
                                <?php
                                if ($lvl == 3) {
                                    $query = "SELECT * from examen WHERE id_nurse = '$id_perso_session' and etat=1 and open_close!=1";
                                } elseif ($lvl == 5) {
                                    $query = "SELECT * from examen where id_medecin='$id_perso_session' and etat=1 and open_close!=1";
                                } else {

                                    $query = "SELECT * from examen where etat=1 and open_close!=1";
                                }
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?= dateToFrench($date_exa, " j F Y") ?></td>
