    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid">
                <h1 class="mt-4">Nouveau utilisateur pour Spécialiste</h1>
                        ...
                        <div class="card mb-4">
                            ...
                            <form class="form-horizontal" action="inscription_traitement_specialiste.php" method="POST">
                                                    ...
                                                    <td>
                                                        <div class="col">
                                                            <ul class="nav nav-pills">
                                                                ...
                                                                <li class="nav-item">
                                                                    <a class="nav-link" data-toggle="tab" href="#a5">
                                                                        <i class="fa fa-address-card"></i>
                                                                        Radiologue
                                                                    </a>
                                                                </li>
                                                            ...
                                                            <div class="tab-content">
                                                                ...
                                                                <div class="tab-pane " id="a4">
                                                                    <span class="help-block small-font" >Infirmier(ière) :</span>
                                                                    <div class="col">
                                                                        ...
                                                                        <button type="button" data-toggle="modal"  style="background-color: transparent"><a href="nouveau_radiologue.php"><i class="fas fa-plus"></i></a>
                                                                    </div>
                                                                </div>
                                                                <div class="tab-pane " id="a5">
                                                                    <span class="help-block small-font" >Radiologue :</span>
                                                                    <div class="col">
                                                                        <select name="id_radiologue" style="width:75%;
                                                                                border-top: 0; border-left: 0;
                                                                                border-right: 0;
                                                                                background: transparent;">
                                                                            <option value="0" selected>...</option>
                                                                            ...
                                                                            $iResult = $db->query('SELECT * FROM radiologue where open_close!=1');
                                ...
                                <center>
                                    ...
                                    <a href="liste_user_specialiste.php" style=" width:150px;"
