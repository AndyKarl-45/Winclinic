    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid">
                <h1 class="mt-4"><i class="fas fa-hospital-alt" style="color: silver"></i>Magasin de fourniture</h1>
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <ul class="nav nav-pills"   style="float: right;">
                            <li class="nav-item">
                                <a class="nav-link active" href="etat_excel_magasin_outil.php" target="blank" style="margin-right: 20px" ><i class="fas fa-download"></i> Exporter
                                </a>
                            </li>
                        </ul>
                        <ul class="nav nav-pills"   style="float: right;">
                            <li class="nav-item">
                                <a class="nav-link active" href="etat_print_magasin_outil.php" target="blank" style="margin-right: 20px" ><i class="fa fa-print"></i> Imprimer
                                </a>
                            </li>
                        </ul>
                    </div>
...
<!--                                    <th>Ref Produit</th>-->
                                ...
                                $query = "SELECT * from magasin_outil";
                                $q = $db->query($query);
                                while ($row = $q->fetch()) {
                                $id_mag_outil = $row['id_mag_outil'];
                                $id_outil_outil = $row['id_outil_outil'];
...
<!--                                    <td align="center"> --><?php ////echo $ref_medi; ?><!--   </td>-->
                                    <td><a href="#"><i class="fas fa-cubes" aria-hidden="true"></i> <?=$id_num_lot_outil?></a></td>
                                    <td><a href="#"><i class="fas fa-cubes" aria-hidden="true"></i> <?=$nom_outil?></a></td>
                                    <td align="center"><?php echo number_format($qt_com_outil) ?>  </td>
                                    <td align="center"><?=$type_outil?> </td>
                                    <td><a href="#"><?=number_format($prix_u_a*$qt_com_outil)?></a></td>
                                    <td><a href="#"><?=number_format($prix_u_v*$qt_com_outil)?></a></td>
                                    <td><a href="#"><?=number_format(($prix_u_v*$qt_com_outil)-($qt_com*$prix_u_a))?></a></td>
