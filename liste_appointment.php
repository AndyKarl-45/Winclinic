                                ...
                                <table class="table table-border table-striped custom-table mb-0" id="dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        if ($lvl == 5) {
                                            ...
                                            $query = "SELECT * from appointment where id_laboratin='$id_perso_session' order by date_apt, time_apt";
                                        }else {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php
                                            ...
                                            foreach ($tables as $table) {
                                                echo $table['nom_n'].' '.$table['prenom_n'];
                                        ...
                                        <td><?php
                                                    ...
                                                    $sql = "SELECT DISTINCT * from laboratin where id_laboratin = '$id_labo'";
                                                    ...
                                                    foreach ($tables as $table) {
                                                        echo $table['nom_l'].' '.$table['prenom_l'];
