...
$heure = date("G:i");
$query  = " UPDATE pharmacie  SET   quantite=:quantite, heure=:heure, date_fab=:date_fab, date_exp=:date_exp, id_num_lot=:id_num_lot
...
?>
    <script>
        ...
        window.location.href = 'liste_mag_phar.php?witness=1';
    </script>
<?php
} else {
?>
