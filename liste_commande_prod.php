    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid">
                <h1 class="mt-4">Détails  Commande :  <?php echo $ref_com?> </h1>
                                                                    ...
                                                                    <table class="table  table-hover table-condensed" id="myTable">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                ...
                                                                                <div class="col">
                                                                                    <input type="date"
                                                                                           class="form-control" name="date_c_com" value="<?=$date_c_com?>" disabled>
                                                                                </div>
                                                                            </td>
                                                                        </tr>
                                                                        ...
                                                                        <form method="post" action="" >
                                                                            <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                                                                                ...
                                                                                <tr class="bg-primary">
                                                                                    ...
                                                                                    <th><p align="center" style="color: white">Numéro de lot</p></th>
                                                                                  ...
                                                                                  $id_medi= $table['id_medi'];
                                                                                    ...
                                                                                    while($row = $q->fetch())
                                                                                    {
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td align="center"><?php echo $id_num_lot ?>  </td>
