    ...
    ////---------------------------- create fournisseur --------------------------------////
        ...
        case '9';
            $id_laboratin = $_POST['id_laboratin'];
                ...
                $query = " INSERT INTO appointment (ref_app,id_patient,id_depart,id_laboratin,date_app,time_app,patient_email,patient_phone,message,date_apt,time_apt) 
                     VALUES (:ref_app,:id_patient,:id_depart,:id_laboratin,:date_app,:time_app,:patient_email,:patient_phone,:message,:date_apt,:time_apt)";
            ...
            $sql->bindParam(':id_patient', $id_patient);
            $sql->bindParam(':id_depart', $id_depart);
            $sql->bindParam(':id_laboratin', $id_laboratin);
            $sql->bindParam(':date_app', $date_app);
            $sql->bindParam(':time_app', $time_app);
            $sql->bindParam(':patient_email', $patient_email);
            $sql->bindParam(':patient_phone', $patient_phone);
            ...
            case '3';
                $id_nusre = $_POST['id_nusre'];

                $query = " INSERT INTO appointment (ref_app,id_patient,id_depart,id_nusre,date_app,time_app,patient_email,patient_phone,message,date_apt,time_apt) 
                     VALUES (:ref_app,:id_patient,:id_depart,:id_nusre,:date_app,:time_app,:patient_email,:patient_phone,:message,:date_apt,:time_apt)";
                ...
                $sql->bindParam(':id_patient', $id_patient);
                $sql->bindParam(':id_depart', $id_depart);
                $sql->bindParam(':id_nusre', $id_nusre);
                $sql->bindParam(':date_app', $date_app);
                $sql->bindParam(':time_app', $time_app);
                $sql->bindParam(':patient_email', $patient_email);
                $sql->bindParam(':patient_phone', $patient_phone);
            ...
            default:
                $id_medecin = $_POST['id_medecin'];
                $id_laborantin = $_POST['id_laborantin'];
                $id_nurse = $_POST['id_nurse'];


                $query = " INSERT INTO appointment (ref_app,id_patient,id_depart,id_medecin,id_laboratin,date_app,time_app,patient_email,patient_phone,message,date_apt,time_apt,id_nurse) 
                     VALUES (:ref_app,:id_patient,:id_depart,:id_medecin,:id_laboratin,:date_app,:time_app,:patient_email,:patient_phone,:message,:date_apt,:time_apt,:id_nurse)";
