                    ...
                    ?>
                        ...
                        <b>
                            ...
                            <ul class="nav nav-pills" style="float: right; margin-right: 20px ;">
                                <li class="nav-item">
                                    <a class="nav-link" href="liste_ecographie_checker_review.php">

                                        <?php

                                        echo ' Ecographie à régler';
                            ...
                            <ul class="nav nav-pills" style="float: right; margin-right: 20px ;">
                                <li class="nav-item">
                                    <a class="nav-link" href="liste_ecographie_suite.php">
                                        ...
                                        if ($lvl == 3) {
                                            $query = "SELECT DISTINCT count(id_eco) as total from ecographie WHERE id_nurse = '$id_perso_session' and etat=0 and open_close!=1";
                                        } elseif ($lvl == 5) {
                                            $query = "SELECT DISTINCT count(id_eco) as total from ecographie WHERE id_medecin = '$id_perso_session' and etat=0 and open_close!=1";
                                        } else {
                                            $query = "SELECT DISTINCT count(id_eco) as total from ecographie where etat=0 and open_close!=1  ";
                                        }
                    ...
                    <div class="table-responsive">
                        <table class="table table-border table-striped custom-table mb-0" id="dataTable">
                            ...
                            <tbody>
                                <?php
                                if ($lvl == 3) {
                                    $query = "SELECT * from ecographie where  id_nurse='$id_perso_session' and etat=1 and open_close!=1 ";
                                } elseif ($lvl == 5) {
                                    $query = "SELECT * from ecographie where  id_medecin='$id_perso_session' and etat=1 and open_close!=1 ";
                                } else {

                                    $query = "SELECT * from ecographie where  etat=1 and open_close!=1 ";
                                }
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center"><a
                                                ...
                                                href="liste_eco_exa.php?ref_eco=<?= $ref_eco ?>"
                                                title="view"
