                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-sm-6">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input type="search" class="form-control" placeholder="barre de recherche..." id="searchBoxRadio" >

                                                                                    <select class="form-control"
                                                                                            name="id_patient" id="countriesRadio">
                                                                    ...
                                                                    <div class="table-responsive">
                                                                        <table class="table table-border table-striped custom-table mb-0" id="TableID" >
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td><input type="date" class="form-control" style=" width: 150px; height: 25px" name="date_radiologie[]"   multiple></td>
                                                                                <td>
