    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid">
                <h1 class="mt-4"><i class="fas fa-clinic-medical" style="color: silver"></i> Liste des médicaments (Pharmacie - Péremption)</h1>
                    ...
                    <div class="col-xl-12">
                        <b>
                            <ul class="nav nav-pills"   style="float: right;">
                                <li class="nav-item">
                                    <a class="nav-link active" href="etat_excel_peremption_phar.php" target="blank" style="margin-right: 20px" ><i class="fas fa-download"></i>Exporter
                                    </a>
                                </li>
                            </ul>
                            <!--<ul class="nav nav-pills"   style="float: right;">-->
