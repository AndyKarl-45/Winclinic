...
$query = "SELECT * from service where id_service='" . $service . "'";
$q = $db->query($query);
while ($row = $q->fetch()) {
...
<div id="layoutSidenav_content">
  <main>
    <div class="container-fluid">
      <h1 class="mt-4"><i class="fas fa-tasks" style="color: silver"></i> Details memsuels : <?= $nom_service ?> </h1>
          ...
          <div class="table-responsive">
            <table class="table table-border table-striped custom-table mb-0" id="dataTable">
              ...
              <tbody>
                ...
                $query = "SELECT SUM(remise)  as rem, Count($id_type_service) as qte, $date_service[$i] as date_service, $id_type_service as id_type  FROM $service WHERE id_caisse = '$id_caisse'  group by $date_service[$i] order by $date_service[$i] desc";
                ...
                ?>
                  ...
                  <tr>
                    <!--                                        <td><a href="#">--><?php //echo $id_hist_caisse;
                                                                                    ?><!--</a></td>-->
                    <td><a href="#"><?php $sql = "SELECT * from $type_services[$i] where $table_services[$i] = '$id_type' and open_close!=1";
