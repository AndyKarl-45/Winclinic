...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid">
            <h1 class="mt-4"><i class="fas fa-users" style="color: silver"></i> Liste des Ordonnances </h1>
                    ...
                    <div class="table-responsive">
                        <table class="table table-border table-striped custom-table mb-0" id="dataTable">
                            ...
                            <tbody>
                                ...
                                $query = "SELECT * from regler_ordo where DATE(date_reg_paie) >= CURDATE() and etat=1";
                                $q = $db->query($query);
                                while ($row = $q->fetch()) {
