...
//}
    ...
    //$prix=$_POST['prix'];
    echo'<br>'.$ref_com_outil=$_POST['ref_com_outil'];
...
//                $sql->execute();
                 $query = " INSERT INTO commande_outil (id_four,ref_com_outil,id_outil,qt_com_outil,date_c_com,date_l_com,date_r_com,mode_paie,obs,id_num_lot_outil,date_exp,date_fab) 
                     VALUES (:id_four,:ref_com_outil,:id_outil,:qt_com_outil,:date_c_com,:date_l_com,:date_r_com,:mode_paie,:obs,:id_num_lot_outil,:date_exp,:date_fab)";
