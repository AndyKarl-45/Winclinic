                        ...
                        <div class="table-responsive">
                            <table class="table table-border table-striped custom-table mb-0" id="dataTable">
                                ...
                                <tr>
                                    ...
                                    <th><p align="center" >Descriptions</p></th>
                                ...
                                while($row = $q->fetch())
                                {
                                    ...
                                    <tr>
                                        ...
                                        <td align="center"> <a
                                                   ...
                                                   data-toggle="modal" data-target="#description<?=$id_type_exa?>"
                                                    title="view"
                                                    style="background-color: transparent">
                                                <i style="color: green" class="fas fa-eye"></i>
                                            </a> 
                                        <div class="modal fade" id="description<?= $id_type_exa ?>" role="dialog">
                                                        ...
                                                        <div class="modal-body" style="padding:40px 50px;">
                                                            <form class="form-horizontal" action="#"
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-sm-12">
                                                                        <textarea class="form-control" rows="5"  cols="70" disabled><?=$description?></textarea>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <div class="col-sm-12">
                                                            ...
                                                            <form class="form-horizontal" action="update_type_examen.php"
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label>description:</label>
                                                                        <div class="col-sm-12">
                                                                            <textarea class="form-control" rows="5"  cols="70" name="description"><?=$description?></textarea>
                                                                        </div>
                                                                    </div>
                ...
                <div class="modal-body" style="padding:40px 50px;">
                    <form class="form-horizontal" action="save_type_examen.php" name="form" method="post">
                        ...
                        <div class="form-group">
                            <label>description:</label>
                            <div class="col-sm-12">
                                <textarea class="form-control" rows="5"  cols="70" name="description"></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-12">
