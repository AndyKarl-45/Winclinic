                ...
                <div class="nav">
                    ...
                    ?>
                        ...
                        <?php if ($lvl == 3 || $lvl == 5 || $lvl == 2 || $lvl == 9 || $lvl == 15) { ?>
                            <!--***************Examen***********************-->
                            <a class="nav-link collapsed" href="<?= $examen['option1_link'] ?>" aria-expanded="false"
                                aria-controls="pagesCollapseError">
                        ...
                        <?php if ($lvl == 3 || $lvl == 5 || $lvl == 2 || $lvl == 15) { ?>
                            ...
                            <a class="nav-link collapsed" href="<?= $ecographie['option2_link'] ?>" aria-expanded="false"
                                ...
                                <?= $ecographie['option1_name'] ?>
                            </a>
                            <a class="nav-link collapsed" href="<?= $ecographie['option2_link'] ?>" aria-expanded="false"
                                aria-controls="pagesCollapseError">
                                <div class="sb-nav-link-icon"><i class="<?= $ecographie['icon'] ?>"></i></div>
                                <?= $ecographie['option2_name'] ?>
                            </a>


                            <a class="nav-link collapsed" href="<?= $autreServices['option1_link'] ?>" aria-expanded="false"
                                aria-controls="pagesCollapseError">
                                <div class="sb-nav-link-icon"><i class="<?= $autres_services['icon'] ?>"></i></div>
                                <?= $autres_services['option1_name'] ?>
                            </a>
                            <a class="nav-link collapsed" href="<?= $autres_services['option2_link'] ?>" aria-expanded="false"
                                aria-controls="pagesCollapseError">
                                <div class="sb-nav-link-icon"><i class="<?= $autres_services['icon'] ?>"></i></div>
                                <?= $autres_services['option2_name'] ?>
                            </a>

                            <a class="nav-link collapsed" href="<?= $diagnostique['option1_link'] ?>" aria-expanded="false"
                                aria-controls="pagesCollapseError">
                                <div class="sb-nav-link-icon"><i class="<?= $diagnostique['icon'] ?>"></i></div>
                                <?= $diagnostique['option1_name'] ?>
                            </a>
                            <a class="nav-link collapsed" href="<?= $diagnostique['option2_link'] ?>" aria-expanded="false"
                                aria-controls="pagesCollapseError">
                                <div class="sb-nav-link-icon"><i class="<?= $diagnostique['icon'] ?>"></i></div>
                                <?= $diagnostique['option2_name'] ?>
                            </a>
                        <?php } ?>
                    <?php
                    }
