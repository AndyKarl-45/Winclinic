...
$query  = "SELECT * from commande_outil where ref_com_outil='".$ref_com_outil."'  LIMIT 1" ;
$q = $db->query($query);
while($row = $q->fetch())
{
    $id_com = $row['id_com'];
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                <b>
                                    ...
                                    <ul class="nav nav-pills" style="float: right;">
                                        <li class="nav-item">
                                            <a class="nav-link active" href="liste_com_outil.php">
                                                Retour
                                            </a>
                                        </li>
                                    </ul>
                            ...
                            <div class="card-body">
                                ...
                                <div class="tab-content">
                                    <form action="update_com_outil.php" method="POST">
                                    <!-- Etat Civile-->
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-sm-6">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div>
                                                                                        <input type="text"
                                                                                               class="form-control" name="ref_com_outil" value="<?=$ref_com_outil?>" disabled>
                                                                                        <input type="hidden"
                                                                                               class="form-control" name="ref_com_outil" value="<?=$ref_com_outil?>" >
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-sm-6">
...
<!--                                            <th>prix HT</th>-->
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="search" class="form-control" placeholder="barre de recherche..." id="searchBox" style=" width: 300px; height: 25px"> <select class="form-control" id="countries"
                                                                                                                                                      name="id_outil[]" style=" width: 300px; height: 25px">
                                                    <?php

                                                    $iResult = $db->query("SELECT * FROM outil ");

                                                    while ($data = $iResult->fetch()) {

                                                        $i = $data['id_outil'];
                                                        echo '<option value ="' . $i . '">';
                                                        echo $data['nom_outil'].' - '.$data['prix_u_v'];
                                                        echo '</option>';
...
<!--                                            <td><input type="number" class="form-control" style=" width: 120px; height: 25px" name="prix[]" value="0" min="0"  multiple></td>-->
                                ...
                                <div class="m-t-20 text-center">
                                    ...
                                    <a href="liste_com_outil.php" style=" width:150px;" class="btn btn-danger"><font>Annuler</font></a>
                                </div>
                                </form>
                            </div>
                            <div class="card-footer">
