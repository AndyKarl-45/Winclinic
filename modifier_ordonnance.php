                                                        ...
                                                        <fieldset>
                                                            <div class="table-responsive">
                                                                <div class="col-lg-8 offset-lg-2">
                                                                    <form action="update_ordonnance.php" method="POST">
                                                                        <div class="row">
                                                                            <div class="col-md-12">
                                                                                <hr/>
                                                                            </div>
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-sm-6">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div>
                                                                                        <input type="date"
                                                                                               class="form-control" name="date_ordo" value="<?=$date_ordo?>">
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                                ...
                                                                                <table class="table table-border table-striped custom-table mb-0" id="TableID" >
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td> <select class="form-control"
                                                                                                ...
                                                                                                $iResult = $db->query("SELECT * FROM medicament where id_medi = '$id_medi' ");
                                                                                        ...
                                                                                        <td><input type="number" class="form-control" style=" width: 50px; height: 25px" name="quantite[]" value="<?php echo number_format($quantite);?>" min="0"  multiple></td>
