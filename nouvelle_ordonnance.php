...
<!--                                                                                <th>Date création</th>-->
                                                                            ...
                                                                            $query = "SELECT * from pharmacie where  quantite > 0 and date_fab > '$date_days'";
                                                                            $q = $db->query($query);
                                                                            while ($row = $q->fetch()) {
                                                                                $id_phar = $row['id_phar'];
                                                                                ...
                                                                                <td align="center"> <input type="number" id="qteMed<?=$id_medi?>" style=" width: 50px; height: 25px" name="<?php echo 'quantite[]';?>" value="0" min="0" max="<?=$quantite?>" /></td>
                                                                                <td><textarea class="form-control" rows="2" name="<?php echo 'traitement[]';?>"
                                                                                  cols="20"></textarea></td>
<!--                                                                                <td><b>--><?//=$newDate = date("m-Y", strtotime($date_exp));?><!-- </b></td>-->
                                                                                    <td><b><?=$newDate = date("m-Y", strtotime($date_fab));?> </b></td>
                                                                                    <td><b><input type="hidden"  id="prixMed<?=$id_medi?>" value="<?=$prix_vente?>"><input type="number"   style=" width: 100px; height: 25px" id="prixtotal<?=$id_medi?>" value="" readonly> </b></td>
                                                                                <td align="center">
                                                                                    <div class="btn-group mr-2" role="group" aria-label="First group">
                                                                                        <input type="checkbox" id="checkMed<?=$id_medi?>"  style=" width: 25px; height: 25px" name="<?php echo 'id_num_lot[]';?>" value="<?=$id_num_lot?>"  onclick="calculerPrixTotal(<?=$id_medi?>)" />
                                        ...
                                        <div class="col-md-4 col-sm-4  col-lg-3">
                                            <div style="background-color: #EFF3F5;" class="profile-widget">
                                                ...
                                                <div class="dropdown profile-action">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        ...
                                                        if($lvl != 12 ){
                                                            ...
                                                            <a class="dropdown-item" href="modifier_add_caisse.php?id="><i class="fas fa-pen"></i> Edit</a>
                                                            <a class="dropdown-item" href="#" data-toggle="modal" data-target="#delete_doctor"><i
                                                                        class="fas fa-trash"></i> Delete</a>
                                                        <?php } ?>
                                                    </div>
                                                </div>
                                                <h4 class="doctor-name text-ellipsis"><a href="liste_add_caisse.php">Solde Total</a></h4>
                                                ...
                                                <div class="user-country">
                                                    <i class="fas fa-donate"></i> <span id="soldetotal788">0</span> FCFA
                                                </div>
                                            </div>
                                        </div>
                                </div>
