...
?>
<?php
$ref_autre=$_REQUEST['ref_autre'];

$query  = "SELECT * from autre where ref_autre='".$ref_autre."'";
$q = $db->query($query);
while($row = $q->fetch())
{
    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid">
                <h1 class="mt-4">Détails  Services :  <?php echo $ref_autre?> </h1>
                            ...
                            <div class="card-header">
                                <b>
                                    <ul class="nav nav-pills" style="float: right;">
                                        <li class="nav-item">
                                            <a class="nav-link active" href="liste_autres_services.php">
                                                Retour
                                            </a>
                                        </li>
                                    </ul>
                                    ...
                                    <ul class="nav nav-pills">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" data-toggle="pill" href="#menu2">
                                                ...
                                                $query = "SELECT  count( DISTINCT id_autre_service) as total from autre_exa where   ref_autre_exa='$ref_autre'  ";
                                                $q = $db->query($query);
                                                while($row = $q->fetch())
                                                {
                                                                    ...
                                                                    <table class="table  table-hover table-condensed" id="myTable">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                ...
                                                                                <div class="col">
                                                                                    <input type="date"
                                                                                           class="form-control" name="date_r_com" value="<?=$date_autre?>" disabled>
                                                                                </div>
                                                                            </td>
                                                                        </tr>
                                        ...
                                        <div class="row">
                                            <div class="col-xl-12">
                                                <div class="card mb-4">
                                                    <div class="card-header">
                                                        <i class="fas fa-scroll"></i>
                                                        <b>L'ensemble des autres services.</b>
                                                                        ...
                                                                        <form method="post" action="" >
                                                                            <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                                                                                ...
                                                                                <tr class="bg-primary">
                                                                                    ...
                                                                                    <th><p align="center" style="color: white">Services</p></th>
                                                                                ...
                                                                                foreach($tables as $table)
                                                                                {
                                                                                    ...
                                                                                    $query = "SELECT * from autres_services where id_autre_service = '$id_autre_service'  ";
                                                                                    $q = $db->query($query);
                                                                                    while($row = $q->fetch())
                                                                                    {
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td align="center"><?=$date_autre?> </td>
                                                                                            <td align="center"><?php echo number_format($prix_autre_service) ?>  </td>
                                                                                            <td align="center">
                                                                                                <a class="btn btn-warning" data-toggle="modal" data-target="#modifierAutreExa<?=$id_autre_service?>"  title="Modifier"
                                                                                                   style="background-color: transparent">
                                                                                                    <i style="color: orange" class="fas fa-pen"></i>
                                                                                                </a>
                                                                                                <a class="btn btn-danger"  href="delete_autre_exa.php?ref_exa=<?php echo $ref_autre; ?>&id_type_exa=<?=$id_autre_service?>" title="view"
                                                                                                   style="background-color: transparent">
                                                                                                    <i  style="color: red" class="fas fa-trash"></i>
                                                                                                </a>
                                                                                                <div class="modal fade" id="modifierAutreExa<?=$id_autre_service?>" role="dialog">
                                                                                                    <div class="modal-dialog">
                                                                                                        <!-- Modal content-->
                                                                                                        <div class="modal-content">
                                                                                                            <div class="modal-header" style="padding:20px 50px;">
                                                                                                                <h3 align="center"><i class="fas fa-map"></i> <b>Serices</b></h3>
                                                                                                                <button type="button" class="close" data-dismiss="modal" title="Close">&times;</button>
                                                                                                            </div>
                                                                                                            <div class="modal-body" style="padding:40px 50px;">
                                                                                                                <form class="form-horizontal" action="update_autre_exa.php" name="form" method="post">

                                                                                                                    <div class="form-group">
                                                                                                                        <label>Type d'examen:</label>
                                                                                                                        <input  type="hidden" name="ref_autre" value="<?=$ref_autre?>" />
                                                                                                                        <input  type="hidden" name="id_autre" value="<?=$id_autre?>" />
                                                                                                                        <input  type="hidden" name="id_id_autre_service_last" value="<?=$id_autre_service?>" />
                                                                                                                        <div class="col-sm-12">
                                                                                                                            <select class="form-control"
                                                                                                                                    name="id_autre_service_new">
                                                                                                                                <option value="<?=$id_autre_service?>" selected=""><?=$nom?></option>
                                                                                                                                <?php

                                                                                                                                $iResult = $db->query("SELECT * FROM autres_services where open_close!=1 and id_autre_service!='$id_autre_service' ");

                                                                                                                                while ($data = $iResult->fetch()) {

                                                                                                                                    $i = $data['id_autre_service'];
                                                                                                                                    echo '<option value ="' . $i . '">';
                                                                                                                                    echo $data['nom'];
                                                                                                                                    echo '</option>';
                                                                                                                    ...
                                                                                                                    <div class="form-group">
                                                                                                                        <label>Date :</label>
                                                                                                                        <div class="col-sm-12">
                                                                                                                            <input class="form-control" type="date" name="date_autre" value="<?=$date_autre?>" />
                                                                                                                        </div>
                                                                                                                    </div>
                                                                                                                    <div class="form-group">
                                                                                                                        <div class="col-sm-12">
