                            ...
                            <div class="card-header">
                                <b>
                                    ...
                                    <ul class="nav nav-pills">
                                        ...
                                        <?php $disabled='disabled'; }else{$disabled='';}?>
                                    </ul> 
                                </b>
                            </div>
                                                                    ...
                                                                    <form action="update_consultation.php" method="POST">
                                                                        <div class="row">
                                                                            <div class="col-sm-6">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <label>Patient <span
                                                                                            ...
                                                                                            <?php if($lvl == 4 and $lvl == 7){ ?>
                                                                                    <select class="form-control"
                                                                                            name="id_patient" <?=$disabled?> >
                                                                            ...
                                                                            <div class="col-sm-6">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <?php }elseif(!empty($id_nurse)){?>
                                                                                    <select class="form-control" name="id_nurse" readonly>
                                                                                        <option value="<?=$id_nurse?>" selected=""><?=$nom_nurse?></option>
                                                                                    </select>
                                                                                    <?php }elseif($lvl ==3){?>
                                                                                    <input type="hidden"  name="id_nurse" value="<?=$id_perso_session?>" >
                                                                                    <select class="form-control" name="id_nurse" disabled>
                                                                                        <?php
                                                                            ...
                                                                            <div class="col-sm-6">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="form-group input-group">
                                                                                        <input type="number"
                                                                                               class="form-control"
                                                                                               name="taille" value="<?=$taille?>" <?=$disabled?> />
                                                                            ...
                                                                            <div class="col-sm-6">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="form-group input-group">
                                                                                        <input type="number"
                                                                                               class="form-control" name="poids" value="<?=$poids?>" <?=$disabled?>
                                                                                               />
                                                                                        <div class="input-group-prepend ">
                                                                            ...
                                                                            <div class="col-sm-6">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="form-group input-group">
                                                                                        <input type="number"
                                                                                               class="form-control" name="temp" value="<?=$temp?>" <?=$disabled?>
                                                                                               />
                                                                                        <div class="input-group-prepend ">
                                                                            ...
                                                                            <div class="col-sm-6">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="form-group input-group">
                                                                                        <input type="text"
                                                                                               class="form-control" name="pression" value="<?=$pression?>" <?=$disabled?>
                                                                                              />
                                                                                        <div class="input-group-prepend ">
                                                                            ...
                                                                            <div class="col-sm-6">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="form-group input-group">
                                                                                        <input type="text"
                                                                                               class="form-control" name="sao" value="<?=$sao?>" <?=$disabled?>
                                                                                               value="0"/>
                                                                                        <div class="input-group-prepend ">
                                                                            ...
                                                                            <div class="col-sm-6">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="form-group input-group">
                                                                                        <input type="text"
                                                                                               class="form-control" name="freq" value="<?=$freq?>" <?=$disabled?>
                                                                                               value="0"/>
                                                                                        <div class="input-group-prepend ">
                                                                            ...
                                                                            <div class="col-sm-6">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="form-group input-group">
                                                                                        <input type="text"
                                                                                               class="form-control" name="poul" value="<?=$poul?>" <?=$disabled?>
                                                                                               value="0"/>
                                                                                        <div class="input-group-prepend ">
                                                                            ...
                                                                            <div class="col-sm-6">
                                                                                ...
                                                                                <?php if($lvl !=3){ ?>
                                                                                    <select class="form-control"  name="id_depart" <?=$disabled?>>
                                                                            ...
                                                                            <div class="col-sm-6">
                                                                                ...
                                                                                <?php if($lvl !=3){ ?>
                                                                                    <select class="form-control"  name="id_type_consul" <?=$disabled?>>
                                                                                    ...
                                                                                    <?php }else{ ?>
                                                                                    <input type="hidden"  class="form-control" name="id_type_consul" value="<?=$id_type_consul?>" >
                                                                                    <select class="form-control"  name="id_type_consul" readonly>
                                                                                        <?php
                                                                            ...
                                                                            <div class="col-sm-6">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div>
                                                                                        <?php if($lvl !=3){ ?>
                                                                                        <input type="date"
                                                                                               class="form-control" name="date_con" value="<?=$date_con?>" <?=$disabled?>>
                                                                                        <?php }else {?>
                                                                                        <input type="date"
                                                                                               class="form-control" name="date_con" value="<?=$date_con?>" readonly>
                                                                                               <input type="hidden"  class="form-control" name="date_con" value="<?=$date_con?>" >
                                                                                        <?php } ?>
                                                                                    </div> 
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <textarea class="form-control" rows="3"
                                                                                      cols="30" name="obs" <?=$disabled?> ><?=$obs?></textarea>
                                                                            <?php }else{ ?>
                                                                             <textarea class="form-control" rows="3"
                                                                                      cols="30" name="obs" readonly ><?=$obs?></textarea>
                                                                             <input type="hidden"  class="form-control" name="obs" value="<?=$obs?>" >
                                                                            <?php } ?>
                                                                        </div>
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <select class="form-control" name="id_medecin">
                                                                                        ...
                                                                                        if($lvl == 5){
                                                                                            ...
                                                                                            echo'<option value="'.$id_medecin.'" selected="">'.$nom_medecin.'</option>';
                                                                                        }
