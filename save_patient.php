...
// }
 ...
 while ($row = $sql->fetch()) {
  ...
  // $a=date("d-m-Y", strtotime($date_begin_chantier));
    ...
    $query = " INSERT INTO patient (ref_patient,nom_p,prenom_p,age_p,username_p,email_p,password_p,check_password_p,date_aniv_p,genre_p, adresse_p,pays_p,ville_p,phone_p,biography_p,id_ent,id_ass,pers,pers_tel) 
                     VALUES (:ref_patient,:nom,:prenom,:age,:username,:email,:password,:check_password,:date_aniv,:gender,:adresse,:pays,:ville,:phone,:biography,:id_ent,:id_ass,:pers,:pers_tel)";
...
//    $sql->bindParam(':code_postal', $code_postal);
    ...
    $sql->bindParam(':pers', $pers);
    $sql->bindParam(':pers_tel', $pers_tel);
