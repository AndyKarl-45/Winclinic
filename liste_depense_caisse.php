...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid">
            <h1 class="mt-4"><i class="fas fa-tasks" style="color: silver"></i> Liste des dépenses de caisses</h1>
                    ...
                    <div class="table-responsive">
                        <table class="table table-border table-striped custom-table mb-0" id="dataTable">
                            ...
                            <tbody>
                                <?php
                                if ($lvl == 2) {
                                    $query = "SELECT * from depense_caisse where id_perso='$id_perso_session' and etat=0 and open_close!='1'  order by date_deps asc";
                                } else {
                                    $query = "SELECT * from depense_caisse where  etat=0 and open_close!='1'  order by date_deps asc";
                                }
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <!---->
                                        <!--                                                    <a class="dropdown-item" href="depense_caisse.php?id_caisse=--><? //=$id_deps_caisse
                                                                                                                                                                ?><!--"><i-->
